...
# mude ryze pelo nome do seu modulo nos imports abaixo
import advsearch.ryze.minimax as minimax          
import advsearch.ryze.tttm_minimax as tttm_agent  
...
class TestAlphaBetaTTTM(unittest.TestCase):
    ...
    def test_utility(self):
        """
        Esse teste verifica a funcao utility em advsearch.ryze.tttm_minimax
        """
